function inicio(){
  ...
  document.getElementById("content").innerHTML = `
  <div id="toEraseAndAddContentDiv">
...
function deleteDiv(month){
  ...
  if(month == "Octubre del 2022"){
    ...
    <iframe style="border: 1px solid #777;" src="https://indd.adobe.com/embed/167c0345-b2e9-48c8-8eca-5128d05f5f31?startpage=1&allowFullscreen=true" width="600px" height="760px" frameborder="0" allowfullscreen=""></iframe>
    ...
    document.getElementById("toEraseAndAddContentDiv").innerHTML = `<h1 class="text-center">${month}</h1>
    <div class="align-middle">
    <iframe style="border: 1px solid #777;" src="https://indd.adobe.com/embed/9b95b3b2-163b-48b6-beac-0c2d67f0b26e?startpage=1&allowFullscreen=true" width="600px" height="760px" frameborder="0" allowfullscreen=""></iframe>
    </div>
    `;
  }
    ...
    document.getElementById("toEraseAndAddContentDiv").innerHTML = `<h1 class="text-center">${month}</h1>
    <div class="align-middle">
    <iframe style="border: 1px solid #777;" src="https://indd.adobe.com/embed/00c9b805-9751-4876-86b5-beffab24f682?startpage=1&allowFullscreen=true" width="600px" height="760px" frameborder="0" allowfullscreen=""></iframe>
    </div>
    `;
  }
    ...
    document.getElementById("toEraseAndAddContentDiv").innerHTML = `<h1 class="text-center">${month}</h1>
    <div class="align-middle">
      <iframe style="border: 1px solid #777;" src="https://indd.adobe.com/embed/fac465e0-cafd-4e9d-8f88-0a805e19518c?startpage=1&allowFullscreen=true" width="600px" height="760px" frameborder="0" allowfullscreen=""></iframe>
    </div>
    `;
  }
}