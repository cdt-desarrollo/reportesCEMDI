...
function showReport(month){
  ...
  if(month == "enero2023"){
    Swal.fire({
      html: '<iframe style="border: 1px solid #777;" src="https://indd.adobe.com/embed/fac465e0-cafd-4e9d-8f88-0a805e19518c?startpage=1&allowFullscreen=false" width="450px" height="760px" frameborder="0" allowfullscreen=""></iframe>',
      imageWidth: width,
      imageHeight: height,
